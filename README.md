# 🛡️ clipmonitor - Portapapeles seguro
...
### Modo compacto (< 110 columnas)

Tres pestañas navegables:
...
- `←` `→` / `Tab`: Cambiar de pestaña (modo compacto)
- `1` `2` `3`: Ir directamente a una pestaña (modo compacto)
